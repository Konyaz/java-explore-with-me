...
public class StatsServiceImplTest {
    ...
    // Тест успешного сохранения информации о посещении
    @Test
    ...
    // Тест получения уникальной статистики без фильтрации по URI
    @Test
    ...
    // Тест получения неуникальной статистики без фильтрации по URI
    @Test
    ...
    // Тест получения уникальной статистики с фильтрацией по URI
    @Test
