...
public class ExceptionErrorHandler {
    ...
    // Обработка ситуации, когда сущность не найдена в базе данных
    ...
    // Обработка конфликтов данных (например, дублирование уникальных значений)
    ...
    // Обработка ситуаций, когда доступ к ресурсу запрещен
    ...
    // Обработка ситуации, когда отсутствуют обязательные параметры запроса
