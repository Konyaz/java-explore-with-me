...
public class AdminCompilationController {
    ...
    // Создание новой подборки событий (может быть пустой)
    ...
    // Удаление существующей подборки по её идентификатору
    ...
    // Обновление информации о подборке (название, закрепление, список событий)
